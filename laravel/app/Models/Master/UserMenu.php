...
class UserMenu extends Model
{
    ...
    {
        return $this->belongsToMany(UserGroup::class, 'user_menu_groups');
    }
    ...
    {
        return $this->hasMany(UserMenu::class, 'parent_id', 'id')->with('childrens');
    }
    ...
    {
        $total_records = $this
            ->where($this->user_groups()->getQualifiedForeignPivotKeyName(), $user_menu_id)
            ->where($this->user_groups()->getQualifiedRelatedPivotKeyName(), $user_group_id)
            ->join($this->user_groups()->getTable(), $this->user_groups()->getQualifiedForeignPivotKeyName(), '=', $this->getTable().'.'. $this->getKeyName());
    ...
    {
    	return new \App\Models\Dashboard\UserMenuCollection($models, $param);
    }
